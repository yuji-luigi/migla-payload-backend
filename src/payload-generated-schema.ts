...
export const enum_notifications_links_link_appearance = pgEnum(
  'enum_notifications_links_link_appearance',
  ['default', 'outline'],
)
...
export const pages = pgTable(
  'pages',
  {
    ...
    hero_mediaClassNames: varchar('hero_media_class_names'),
...
export const _pages_v = pgTable(
  '_pages_v',
  {
    ...
    version_hero_mediaClassNames: varchar('version_hero_media_class_names'),
...
export const teachers = pgTable(
  'teachers',
  {
    ...
    classroom: integer('classroom_id').references(() => classrooms.id, {
      onDelete: 'set null',
    }),
    slug: varchar('slug'),
    slugLock: boolean('slug_lock').default(true),
  ...
  (columns) => ({
    teachers_user_idx: uniqueIndex('teachers_user_idx').on(columns.user),
    teachers_classroom_idx: index('teachers_classroom_idx').on(columns.classroom),
    teachers_slug_idx: index('teachers_slug_idx').on(columns.slug),
    teachers_updated_at_idx: index('teachers_updated_at_idx').on(columns.updatedAt),
    teachers_created_at_idx: index('teachers_created_at_idx').on(columns.createdAt),
  }),
)

export const teachers_locales = pgTable(
  'teachers_locales',
  {
    name: varchar('name').notNull(),
    id: serial('id').primaryKey(),
  ...
  (columns) => ({
    _localeParent: uniqueIndex('teachers_locales_locale_parent_id_unique').on(
      columns._locale,
      columns._parentID,
    ),
    _parentIdFk: foreignKey({
      ...
      name: 'teachers_locales_parent_id_fk',
    }).onDelete('cascade'),
  }),
)
...
export const students = pgTable(
  ...
  (columns) => ({
    students_parent_idx: index('students_parent_idx').on(columns.parent),
    students_classroom_idx: index('students_classroom_idx').on(columns.classroom),
    students_slug_idx: index('students_slug_idx').on(columns.slug),
    students_updated_at_idx: index('students_updated_at_idx').on(columns.updatedAt),
    students_created_at_idx: index('students_created_at_idx').on(columns.createdAt),
  }),
)
...
export const reports = pgTable(
  'reports',
  {
    ...
    teacher: integer('teacher_id').references(() => teachers.id, {
      onDelete: 'set null',
    }),
    slug: varchar('slug'),
    slugLock: boolean('slug_lock').default(true),
  ...
  (columns) => ({
    reports_created_by_idx: index('reports_created_by_idx').on(columns.createdBy),
    reports_teacher_idx: index('reports_teacher_idx').on(columns.teacher),
...
export const reports_locales = pgTable(
  'reports_locales',
  {
    title: varchar('title').notNull(),
  ...
  (columns) => ({
    reports_cover_image_idx: index('reports_cover_image_idx').on(
      columns.coverImage,
      columns._locale,
    ),
    _localeParent: uniqueIndex('reports_locales_locale_parent_id_unique').on(
      columns._locale,
      columns._parentID,
    ),
    _parentIdFk: foreignKey({
...
export const reports_rels = pgTable(
  ...
  (columns) => ({
    ...
    localeIdx: index('reports_rels_locale_idx').on(columns.locale),
    reports_rels_media_id_idx: index('reports_rels_media_id_idx').on(
      columns.mediaID,
      columns.locale,
    ),
    reports_rels_students_id_idx: index('reports_rels_students_id_idx').on(
      columns.studentsID,
      columns.locale,
    ),
    parentFk: foreignKey({
    ...
    mediaIdFk: foreignKey({
      ...
      name: 'reports_rels_media_fk',
    }).onDelete('cascade'),
    studentsIdFk: foreignKey({
      columns: [columns['studentsID']],
      foreignColumns: [students.id],
      name: 'reports_rels_students_fk',
    }).onDelete('cascade'),
  }),
)
...
export const classrooms = pgTable(
  ...
  {
    id: serial('id').primaryKey(),
    ord: numeric('ord').notNull().default('0'),
    slug: varchar('slug'),
    slugLock: boolean('slug_lock').default(true),
    updatedAt: timestamp('updated_at', { mode: 'string', withTimezone: true, precision: 3 })
      .defaultNow()
  ...
  (columns) => ({
    classrooms_slug_idx: index('classrooms_slug_idx').on(columns.slug),
    classrooms_updated_at_idx: index('classrooms_updated_at_idx').on(columns.updatedAt),
    classrooms_created_at_idx: index('classrooms_created_at_idx').on(columns.createdAt),
  }),
)

export const classrooms_locales = pgTable(
  'classrooms_locales',
  {
    name: varchar('name').notNull(),
  ...
  (columns) => ({
    classrooms_name_idx: uniqueIndex('classrooms_name_idx').on(columns.name, columns._locale),
    _localeParent: uniqueIndex('classrooms_locales_locale_parent_id_unique').on(
      columns._locale,
      columns._parentID,
    ),
    _parentIdFk: foreignKey({
      ...
      name: 'classrooms_locales_parent_id_fk',
    }).onDelete('cascade'),
  }),
)

export const classrooms_rels = pgTable(
  'classrooms_rels',
  {
    id: serial('id').primaryKey(),
    order: integer('order'),
    parent: integer('parent_id').notNull(),
    path: varchar('path').notNull(),
    teachersID: integer('teachers_id'),
  },
  (columns) => ({
    order: index('classrooms_rels_order_idx').on(columns.order),
    parentIdx: index('classrooms_rels_parent_idx').on(columns.parent),
    pathIdx: index('classrooms_rels_path_idx').on(columns.path),
    classrooms_rels_teachers_id_idx: index('classrooms_rels_teachers_id_idx').on(
      columns.teachersID,
    ),
    parentFk: foreignKey({
      columns: [columns['parent']],
      foreignColumns: [classrooms.id],
      name: 'classrooms_rels_parent_fk',
    }).onDelete('cascade'),
    teachersIdFk: foreignKey({
      columns: [columns['teachersID']],
      foreignColumns: [teachers.id],
      name: 'classrooms_rels_teachers_fk',
    }).onDelete('cascade'),
  }),
)

export const notifications_links = pgTable(
  'notifications_links',
  {
    _order: integer('_order').notNull(),
    _parentID: integer('_parent_id').notNull(),
    _locale: enum__locales('_locale').notNull(),
    id: varchar('id').primaryKey(),
    link_type: enum_notifications_links_link_type('link_type').default('reference'),
    link_newTab: boolean('link_new_tab'),
    link_url: varchar('link_url'),
    link_label: varchar('link_label').notNull(),
    link_appearance: enum_notifications_links_link_appearance('link_appearance').default('default'),
  },
  (columns) => ({
    _orderIdx: index('notifications_links_order_idx').on(columns._order),
    _parentIDIdx: index('notifications_links_parent_id_idx').on(columns._parentID),
    _localeIdx: index('notifications_links_locale_idx').on(columns._locale),
    _parentIDFk: foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [notifications.id],
      name: 'notifications_links_parent_id_fk',
    }).onDelete('cascade'),
  }),
)
...
export const notifications_locales = pgTable(
  ...
  (columns) => ({
    notifications_title_idx: index('notifications_title_idx').on(columns.title, columns._locale),
    _localeParent: uniqueIndex('notifications_locales_locale_parent_id_unique').on(
      columns._locale,
      columns._parentID,
    ),
    _parentIdFk: foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [notifications.id],
      name: 'notifications_locales_parent_id_fk',
    }).onDelete('cascade'),
  }),
)
...
export const notifications_rels = pgTable(
  ...
  (columns) => ({
    ...
    localeIdx: index('notifications_rels_locale_idx').on(columns.locale),
    notifications_rels_media_id_idx: index('notifications_rels_media_id_idx').on(
      columns.mediaID,
      columns.locale,
    ),
    notifications_rels_pages_id_idx: index('notifications_rels_pages_id_idx').on(
      columns.pagesID,
      columns.locale,
    ),
    notifications_rels_posts_id_idx: index('notifications_rels_posts_id_idx').on(
      columns.postsID,
      columns.locale,
    ),
    notifications_rels_students_id_idx: index('notifications_rels_students_id_idx').on(
      columns.studentsID,
      columns.locale,
    ),
    parentFk: foreignKey({
    ...
    mediaIdFk: foreignKey({
      columns: [columns['mediaID']],
      foreignColumns: [media.id],
      name: 'notifications_rels_media_fk',
    }).onDelete('cascade'),
    pagesIdFk: foreignKey({
      columns: [columns['pagesID']],
      foreignColumns: [pages.id],
      name: 'notifications_rels_pages_fk',
    }).onDelete('cascade'),
    postsIdFk: foreignKey({
      columns: [columns['postsID']],
      foreignColumns: [posts.id],
      name: 'notifications_rels_posts_fk',
    }).onDelete('cascade'),
    studentsIdFk: foreignKey({
      columns: [columns['studentsID']],
      foreignColumns: [students.id],
      name: 'notifications_rels_students_fk',
    }).onDelete('cascade'),
  }),
)

export const read_notifications = pgTable(
  'read_notifications',
  {
    id: serial('id').primaryKey(),
    user: integer('user_id')
  ...
  (columns) => ({
    read_notifications_user_idx: index('read_notifications_user_idx').on(columns.user),
    read_notifications_notification_idx: index('read_notifications_notification_idx').on(
      columns.notification,
    ),
    read_notifications_updated_at_idx: index('read_notifications_updated_at_idx').on(
      columns.updatedAt,
    ),
    read_notifications_created_at_idx: index('read_notifications_created_at_idx').on(
      columns.createdAt,
    ),
    user_notification_idx: uniqueIndex('user_notification_idx').on(
      columns.user,
      columns.notification,
    ),
  }),
...
export const homeworks = pgTable(
  'homeworks',
  {
    ...
    issuedAt: timestamp('issued_at', { mode: 'string', withTimezone: true, precision: 3 }),
    updatedAt: timestamp('updated_at', { mode: 'string', withTimezone: true, precision: 3 })
      .defaultNow()
      .notNull(),
    createdAt: timestamp('created_at', { mode: 'string', withTimezone: true, precision: 3 })
  ...
  (columns) => ({
    homeworks_teacher_idx: index('homeworks_teacher_idx').on(columns.teacher),
    homeworks_created_by_idx: index('homeworks_created_by_idx').on(columns.createdBy),
    homeworks_updated_at_idx: index('homeworks_updated_at_idx').on(columns.updatedAt),
    homeworks_created_at_idx: index('homeworks_created_at_idx').on(columns.createdAt),
  }),
)

export const homeworks_rels = pgTable(
  'homeworks_rels',
  {
    id: serial('id').primaryKey(),
    order: integer('order'),
  ...
  (columns) => ({
    order: index('homeworks_rels_order_idx').on(columns.order),
    parentIdx: index('homeworks_rels_parent_idx').on(columns.parent),
    pathIdx: index('homeworks_rels_path_idx').on(columns.path),
    homeworks_rels_students_id_idx: index('homeworks_rels_students_id_idx').on(columns.studentsID),
    homeworks_rels_media_id_idx: index('homeworks_rels_media_id_idx').on(columns.mediaID),
    parentFk: foreignKey({
      columns: [columns['parent']],
      foreignColumns: [homeworks.id],
      name: 'homeworks_rels_parent_fk',
    }).onDelete('cascade'),
    studentsIdFk: foreignKey({
      columns: [columns['studentsID']],
      foreignColumns: [students.id],
      name: 'homeworks_rels_students_fk',
    }).onDelete('cascade'),
    mediaIdFk: foreignKey({
      columns: [columns['mediaID']],
      foreignColumns: [media.id],
      name: 'homeworks_rels_media_fk',
    }).onDelete('cascade'),
  }),
)
...
export const roles = pgTable(
  ...
  (columns) => ({
    ...
    roles_slug_idx: index('roles_slug_idx').on(columns.slug),
...
export const roles_locales = pgTable(
  ...
  (columns) => ({
    roles_label_idx: uniqueIndex('roles_label_idx').on(columns.label, columns._locale),
    _localeParent: uniqueIndex('roles_locales_locale_parent_id_unique').on(
      columns._locale,
      columns._parentID,
    ),
    _parentIdFk: foreignKey({
...
export const settings = pgTable(
  ...
  {
    id: serial('id').primaryKey(),
    locale: enum_settings_locale('locale').notNull(),
...
export const payload_locked_documents_rels = pgTable(
  'payload_locked_documents_rels',
  {
    ...
    classroomsID: integer('classrooms_id'),
    notificationsID: integer('notifications_id'),
    'read-notificationsID': integer('read_notifications_id'),
    homeworksID: integer('homeworks_id'),
    mediaID: integer('media_id'),
    rolesID: integer('roles_id'),
  ...
  (columns) => ({
    ...
    payload_locked_documents_rels_teachers_id_idx: index(
      'payload_locked_documents_rels_teachers_id_idx',
    ).on(columns.teachersID),
    payload_locked_documents_rels_students_id_idx: index(
      'payload_locked_documents_rels_students_id_idx',
    ).on(columns.studentsID),
    payload_locked_documents_rels_reports_id_idx: index(
      'payload_locked_documents_rels_reports_id_idx',
    ).on(columns.reportsID),
    payload_locked_documents_rels_classrooms_id_idx: index(
      'payload_locked_documents_rels_classrooms_id_idx',
    ).on(columns.classroomsID),
    ...
    payload_locked_documents_rels_read_notifications_id_idx: index(
      'payload_locked_documents_rels_read_notifications_id_idx',
    ).on(columns['read-notificationsID']),
    payload_locked_documents_rels_homeworks_id_idx: index(
      'payload_locked_documents_rels_homeworks_id_idx',
    ).on(columns.homeworksID),
    ...
    teachersIdFk: foreignKey({
      columns: [columns['teachersID']],
      foreignColumns: [teachers.id],
      name: 'payload_locked_documents_rels_teachers_fk',
    }).onDelete('cascade'),
    studentsIdFk: foreignKey({
      columns: [columns['studentsID']],
      foreignColumns: [students.id],
    ...
    classroomsIdFk: foreignKey({
      columns: [columns['classroomsID']],
      foreignColumns: [classrooms.id],
      name: 'payload_locked_documents_rels_classrooms_fk',
    }).onDelete('cascade'),
    ...
    'read-notificationsIdFk': foreignKey({
      columns: [columns['read-notificationsID']],
      foreignColumns: [read_notifications.id],
      name: 'payload_locked_documents_rels_read_notifications_fk',
    }).onDelete('cascade'),
    homeworksIdFk: foreignKey({
      columns: [columns['homeworksID']],
      foreignColumns: [homeworks.id],
      name: 'payload_locked_documents_rels_homeworks_fk',
    }).onDelete('cascade'),
    mediaIdFk: foreignKey({
      columns: [columns['mediaID']],
      foreignColumns: [media.id],
...
export const logo_global = pgTable(
  'logo_global',
  {
    id: serial('id').primaryKey(),
    logo_square: integer('logo_square_id').references(() => media.id, {
      onDelete: 'set null',
    }),
    logo_rectangle: integer('logo_rectangle_id').references(() => media.id, {
      onDelete: 'set null',
    }),
    logo_icon: integer('logo_icon_id').references(() => media.id, {
      onDelete: 'set null',
    }),
    updatedAt: timestamp('updated_at', { mode: 'string', withTimezone: true, precision: 3 }),
    createdAt: timestamp('created_at', { mode: 'string', withTimezone: true, precision: 3 }),
  ...
  (columns) => ({
    logo_global_logo_square_idx: index('logo_global_logo_square_idx').on(columns.logo_square),
    logo_global_logo_rectangle_idx: index('logo_global_logo_rectangle_idx').on(
      columns.logo_rectangle,
    ),
    logo_global_logo_icon_idx: index('logo_global_logo_icon_idx').on(columns.logo_icon),
  }),
)
...
export const relations_teachers_locales = relations(teachers_locales, ({ one }) => ({
  _parentID: one(teachers, {
    fields: [teachers_locales._parentID],
    references: [teachers.id],
    relationName: '_locales',
  }),
}))
export const relations_teachers = relations(teachers, ({ one, many }) => ({
  user: one(users, {
    fields: [teachers.user],
    references: [users.id],
    relationName: 'user',
  }),
  classroom: one(classrooms, {
    fields: [teachers.classroom],
    references: [classrooms.id],
    relationName: 'classroom',
  }),
  _locales: many(teachers_locales, {
    relationName: '_locales',
  }),
}))
export const relations_students = relations(students, ({ one }) => ({
  parent: one(users, {
    fields: [students.parent],
    references: [users.id],
    relationName: 'parent',
  }),
  classroom: one(classrooms, {
...
export const relations_reports_locales = relations(reports_locales, ({ one }) => ({
  _parentID: one(reports, {
    fields: [reports_locales._parentID],
    references: [reports.id],
    relationName: '_locales',
  }),
  coverImage: one(media, {
    fields: [reports_locales.coverImage],
    references: [media.id],
...
export const relations_reports_rels = relations(reports_rels, ({ one }) => ({
  ...
  mediaID: one(media, {
    fields: [reports_rels.mediaID],
    references: [media.id],
    relationName: 'media',
  }),
  studentsID: one(students, {
    fields: [reports_rels.studentsID],
...
export const relations_reports = relations(reports, ({ one, many }) => ({
  ...
  teacher: one(teachers, {
    fields: [reports.teacher],
    references: [teachers.id],
    relationName: 'teacher',
  }),
  _locales: many(reports_locales, {
    relationName: '_locales',
  }),
...
export const relations_classrooms_locales = relations(classrooms_locales, ({ one }) => ({
  _parentID: one(classrooms, {
    fields: [classrooms_locales._parentID],
    references: [classrooms.id],
    relationName: '_locales',
  }),
}))
export const relations_classrooms_rels = relations(classrooms_rels, ({ one }) => ({
  parent: one(classrooms, {
    fields: [classrooms_rels.parent],
    references: [classrooms.id],
    relationName: '_rels',
  }),
  teachersID: one(teachers, {
    fields: [classrooms_rels.teachersID],
    references: [teachers.id],
    relationName: 'teachers',
  }),
}))
export const relations_classrooms = relations(classrooms, ({ many }) => ({
  _locales: many(classrooms_locales, {
    relationName: '_locales',
  }),
  _rels: many(classrooms_rels, {
    relationName: '_rels',
  }),
}))
export const relations_notifications_links = relations(notifications_links, ({ one }) => ({
  _parentID: one(notifications, {
    fields: [notifications_links._parentID],
    references: [notifications.id],
    relationName: 'links',
  }),
}))
export const relations_notifications_locales = relations(notifications_locales, ({ one }) => ({
  _parentID: one(notifications, {
    fields: [notifications_locales._parentID],
    references: [notifications.id],
    relationName: '_locales',
  }),
}))
export const relations_notifications_rels = relations(notifications_rels, ({ one }) => ({
  ...
  mediaID: one(media, {
    fields: [notifications_rels.mediaID],
    references: [media.id],
    relationName: 'media',
  }),
  pagesID: one(pages, {
    fields: [notifications_rels.pagesID],
    references: [pages.id],
    relationName: 'pages',
  }),
  postsID: one(posts, {
    fields: [notifications_rels.postsID],
    references: [posts.id],
    relationName: 'posts',
  }),
  studentsID: one(students, {
    fields: [notifications_rels.studentsID],
    references: [students.id],
    relationName: 'students',
  }),
}))
export const relations_notifications = relations(notifications, ({ many }) => ({
  links: many(notifications_links, {
    relationName: 'links',
  }),
  _locales: many(notifications_locales, {
    relationName: '_locales',
  }),
...
export const relations_read_notifications = relations(read_notifications, ({ one }) => ({
  user: one(users, {
    fields: [read_notifications.user],
    references: [users.id],
    relationName: 'user',
  }),
  notification: one(notifications, {
    fields: [read_notifications.notification],
    references: [notifications.id],
    relationName: 'notification',
  }),
}))
export const relations_homeworks_rels = relations(homeworks_rels, ({ one }) => ({
  parent: one(homeworks, {
    fields: [homeworks_rels.parent],
    references: [homeworks.id],
    relationName: '_rels',
  }),
  studentsID: one(students, {
    fields: [homeworks_rels.studentsID],
    references: [students.id],
    relationName: 'students',
  }),
  mediaID: one(media, {
    fields: [homeworks_rels.mediaID],
    references: [media.id],
    relationName: 'media',
  }),
}))
export const relations_homeworks = relations(homeworks, ({ one, many }) => ({
  teacher: one(teachers, {
    fields: [homeworks.teacher],
    references: [teachers.id],
    relationName: 'teacher',
  }),
  createdBy: one(users, {
...
export const relations_payload_locked_documents_rels = relations(
  ...
  ({ one }) => ({
    ...
    teachersID: one(teachers, {
      fields: [payload_locked_documents_rels.teachersID],
      references: [teachers.id],
      relationName: 'teachers',
    }),
    studentsID: one(students, {
    ...
    classroomsID: one(classrooms, {
      fields: [payload_locked_documents_rels.classroomsID],
      references: [classrooms.id],
      relationName: 'classrooms',
    }),
    ...
    'read-notificationsID': one(read_notifications, {
      fields: [payload_locked_documents_rels['read-notificationsID']],
      references: [read_notifications.id],
      relationName: 'read-notifications',
    }),
    homeworksID: one(homeworks, {
      fields: [payload_locked_documents_rels.homeworksID],
      references: [homeworks.id],
      relationName: 'homeworks',
    }),
    mediaID: one(media, {
...
export const relations_logo_global = relations(logo_global, ({ one }) => ({
  logo_square: one(media, {
    fields: [logo_global.logo_square],
    references: [media.id],
    relationName: 'logo_square',
  }),
  logo_rectangle: one(media, {
    fields: [logo_global.logo_rectangle],
    references: [media.id],
    relationName: 'logo_rectangle',
  }),
  logo_icon: one(media, {
    fields: [logo_global.logo_icon],
    references: [media.id],
    relationName: 'logo_icon',
  }),
}))
...
type DatabaseSchema = {
  ...
  enum_notifications_links_link_type: typeof enum_notifications_links_link_type
  ...
  teachers_locales: typeof teachers_locales
  students: typeof students
  reports: typeof reports
  reports_locales: typeof reports_locales
  reports_rels: typeof reports_rels
  classrooms: typeof classrooms
  classrooms_locales: typeof classrooms_locales
  classrooms_rels: typeof classrooms_rels
  notifications_links: typeof notifications_links
  notifications: typeof notifications
  notifications_locales: typeof notifications_locales
  notifications_rels: typeof notifications_rels
  read_notifications: typeof read_notifications
  homeworks: typeof homeworks
  homeworks_rels: typeof homeworks_rels
  media: typeof media
  roles: typeof roles
  ...
  logo_global: typeof logo_global
  ...
  relations_teachers_locales: typeof relations_teachers_locales
  relations_teachers: typeof relations_teachers
  relations_students: typeof relations_students
  relations_reports_locales: typeof relations_reports_locales
  relations_reports_rels: typeof relations_reports_rels
  relations_reports: typeof relations_reports
  relations_classrooms_locales: typeof relations_classrooms_locales
  relations_classrooms_rels: typeof relations_classrooms_rels
  relations_classrooms: typeof relations_classrooms
  relations_notifications_links: typeof relations_notifications_links
  relations_notifications_locales: typeof relations_notifications_locales
  relations_notifications_rels: typeof relations_notifications_rels
  relations_notifications: typeof relations_notifications
  relations_read_notifications: typeof relations_read_notifications
  relations_homeworks_rels: typeof relations_homeworks_rels
  relations_homeworks: typeof relations_homeworks
  ...
  relations_logo_global: typeof relations_logo_global
}
