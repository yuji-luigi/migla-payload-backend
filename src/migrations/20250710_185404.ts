...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_settings_locale" AS ENUM('en', 'ja', 'it');
  ...
  CREATE TABLE IF NOT EXISTS "pages" (
  	...
  	"hero_media_class_names" varchar,
  ...
  CREATE TABLE IF NOT EXISTS "_pages_v" (
  	...
  	"version_hero_media_class_names" varchar,
  ...
  CREATE TABLE IF NOT EXISTS "users" (
  	...
  	"current_role_is_super_admin" boolean,
  	"current_role_is_admin_level" boolean,
  	"current_role_is_teacher" boolean,
  	"current_role_is_parent" boolean,
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"created_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  ...
  CREATE TABLE IF NOT EXISTS "teachers_locales" (
  	"name" varchar NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"_locale" "_locales" NOT NULL,
  	"_parent_id" integer NOT NULL
  ...
  CREATE TABLE IF NOT EXISTS "reports_locales" (
  	"title" varchar NOT NULL,
  ...
  CREATE TABLE IF NOT EXISTS "classrooms_locales" (
  	"name" varchar NOT NULL,
  	"description" varchar,
  	"id" serial PRIMARY KEY NOT NULL,
  	"_locale" "_locales" NOT NULL,
  ...
  CREATE TABLE IF NOT EXISTS "homeworks_rels" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"order" integer,
  	"parent_id" integer NOT NULL,
  	"path" varchar NOT NULL,
  ...
  CREATE TABLE IF NOT EXISTS "roles" (
  	...
  	"can_write_parents" boolean,
  	"can_write_students" boolean,
  ...
  CREATE TABLE IF NOT EXISTS "roles_locales" (
  ...
  CREATE TABLE IF NOT EXISTS "settings" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"locale" "enum_settings_locale" NOT NULL,
  	"user_id" integer,
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"created_at" timestamp(3) with time zone DEFAULT now() NOT NULL
  );
  ...
  CREATE TABLE IF NOT EXISTS "logo_global" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"logo_square_id" integer,
  	"logo_rectangle_id" integer,
  ...
  DO $$ BEGIN
   ALTER TABLE "teachers" ADD CONSTRAINT "teachers_classroom_id_classrooms_id_fk" FOREIGN KEY ("classroom_id") REFERENCES "public"."classrooms"("id") ON DELETE set null ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  DO $$ BEGIN
   ALTER TABLE "reports" ADD CONSTRAINT "reports_teacher_id_teachers_id_fk" FOREIGN KEY ("teacher_id") REFERENCES "public"."teachers"("id") ON DELETE set null ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  DO $$ BEGIN
   ALTER TABLE "reports_rels" ADD CONSTRAINT "reports_rels_media_fk" FOREIGN KEY ("media_id") REFERENCES "public"."media"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "reports_rels" ADD CONSTRAINT "reports_rels_students_fk" FOREIGN KEY ("students_id") REFERENCES "public"."students"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "classrooms_locales" ADD CONSTRAINT "classrooms_locales_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."classrooms"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "classrooms_rels" ADD CONSTRAINT "classrooms_rels_parent_fk" FOREIGN KEY ("parent_id") REFERENCES "public"."classrooms"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "classrooms_rels" ADD CONSTRAINT "classrooms_rels_teachers_fk" FOREIGN KEY ("teachers_id") REFERENCES "public"."teachers"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  DO $$ BEGIN
   ALTER TABLE "notifications_rels" ADD CONSTRAINT "notifications_rels_media_fk" FOREIGN KEY ("media_id") REFERENCES "public"."media"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  DO $$ BEGIN
   ALTER TABLE "notifications_rels" ADD CONSTRAINT "notifications_rels_students_fk" FOREIGN KEY ("students_id") REFERENCES "public"."students"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  DO $$ BEGIN
   ALTER TABLE "homeworks" ADD CONSTRAINT "homeworks_teacher_id_teachers_id_fk" FOREIGN KEY ("teacher_id") REFERENCES "public"."teachers"("id") ON DELETE set null ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "homeworks" ADD CONSTRAINT "homeworks_created_by_id_users_id_fk" FOREIGN KEY ("created_by_id") REFERENCES "public"."users"("id") ON DELETE set null ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "homeworks_rels" ADD CONSTRAINT "homeworks_rels_parent_fk" FOREIGN KEY ("parent_id") REFERENCES "public"."homeworks"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "homeworks_rels" ADD CONSTRAINT "homeworks_rels_students_fk" FOREIGN KEY ("students_id") REFERENCES "public"."students"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "homeworks_rels" ADD CONSTRAINT "homeworks_rels_media_fk" FOREIGN KEY ("media_id") REFERENCES "public"."media"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  DO $$ BEGIN
   ALTER TABLE "settings" ADD CONSTRAINT "settings_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE set null ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  DO $$ BEGIN
   ALTER TABLE "payload_locked_documents_rels" ADD CONSTRAINT "payload_locked_documents_rels_homeworks_fk" FOREIGN KEY ("homeworks_id") REFERENCES "public"."homeworks"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  DO $$ BEGIN
   ALTER TABLE "logo_global" ADD CONSTRAINT "logo_global_logo_square_id_media_id_fk" FOREIGN KEY ("logo_square_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "logo_global" ADD CONSTRAINT "logo_global_logo_rectangle_id_media_id_fk" FOREIGN KEY ("logo_rectangle_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "logo_global" ADD CONSTRAINT "logo_global_logo_icon_id_media_id_fk" FOREIGN KEY ("logo_icon_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  CREATE UNIQUE INDEX IF NOT EXISTS "teachers_user_idx" ON "teachers" USING btree ("user_id");
  CREATE INDEX IF NOT EXISTS "teachers_classroom_idx" ON "teachers" USING btree ("classroom_id");
  CREATE INDEX IF NOT EXISTS "teachers_slug_idx" ON "teachers" USING btree ("slug");
  ...
  CREATE UNIQUE INDEX IF NOT EXISTS "reports_locales_locale_parent_id_unique" ON "reports_locales" USING btree ("_locale","_parent_id");
  ...
  CREATE INDEX IF NOT EXISTS "reports_rels_locale_idx" ON "reports_rels" USING btree ("locale");
  CREATE INDEX IF NOT EXISTS "reports_rels_media_id_idx" ON "reports_rels" USING btree ("media_id","locale");
  CREATE INDEX IF NOT EXISTS "reports_rels_students_id_idx" ON "reports_rels" USING btree ("students_id","locale");
  ...
  CREATE UNIQUE INDEX IF NOT EXISTS "classrooms_name_idx" ON "classrooms_locales" USING btree ("name","_locale");
  CREATE UNIQUE INDEX IF NOT EXISTS "classrooms_locales_locale_parent_id_unique" ON "classrooms_locales" USING btree ("_locale","_parent_id");
  CREATE INDEX IF NOT EXISTS "classrooms_rels_order_idx" ON "classrooms_rels" USING btree ("order");
  CREATE INDEX IF NOT EXISTS "classrooms_rels_parent_idx" ON "classrooms_rels" USING btree ("parent_id");
  CREATE INDEX IF NOT EXISTS "classrooms_rels_path_idx" ON "classrooms_rels" USING btree ("path");
  CREATE INDEX IF NOT EXISTS "classrooms_rels_teachers_id_idx" ON "classrooms_rels" USING btree ("teachers_id");
  ...
  CREATE INDEX IF NOT EXISTS "notifications_title_idx" ON "notifications_locales" USING btree ("title","_locale");
  ...
  CREATE INDEX IF NOT EXISTS "homeworks_teacher_idx" ON "homeworks" USING btree ("teacher_id");
  CREATE INDEX IF NOT EXISTS "homeworks_created_by_idx" ON "homeworks" USING btree ("created_by_id");
  CREATE INDEX IF NOT EXISTS "homeworks_updated_at_idx" ON "homeworks" USING btree ("updated_at");
  CREATE INDEX IF NOT EXISTS "homeworks_created_at_idx" ON "homeworks" USING btree ("created_at");
  CREATE INDEX IF NOT EXISTS "homeworks_rels_order_idx" ON "homeworks_rels" USING btree ("order");
  CREATE INDEX IF NOT EXISTS "homeworks_rels_parent_idx" ON "homeworks_rels" USING btree ("parent_id");
  CREATE INDEX IF NOT EXISTS "homeworks_rels_path_idx" ON "homeworks_rels" USING btree ("path");
  CREATE INDEX IF NOT EXISTS "homeworks_rels_students_id_idx" ON "homeworks_rels" USING btree ("students_id");
  CREATE INDEX IF NOT EXISTS "homeworks_rels_media_id_idx" ON "homeworks_rels" USING btree ("media_id");
  ...
  CREATE INDEX IF NOT EXISTS "roles_slug_idx" ON "roles" USING btree ("slug");
  ...
  CREATE UNIQUE INDEX IF NOT EXISTS "roles_label_idx" ON "roles_locales" USING btree ("label","_locale");
  CREATE UNIQUE INDEX IF NOT EXISTS "roles_locales_locale_parent_id_unique" ON "roles_locales" USING btree ("_locale","_parent_id");
  CREATE INDEX IF NOT EXISTS "settings_user_idx" ON "settings" USING btree ("user_id");
  ...
  CREATE INDEX IF NOT EXISTS "payload_locked_documents_rels_homeworks_id_idx" ON "payload_locked_documents_rels" USING btree ("homeworks_id");
  ...
  CREATE INDEX IF NOT EXISTS "logo_global_logo_square_idx" ON "logo_global" USING btree ("logo_square_id");
  CREATE INDEX IF NOT EXISTS "logo_global_logo_rectangle_idx" ON "logo_global" USING btree ("logo_rectangle_id");
  CREATE INDEX IF NOT EXISTS "logo_global_logo_icon_idx" ON "logo_global" USING btree ("logo_icon_id");`)
}
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "classrooms_locales" CASCADE;
  DROP TABLE "classrooms_rels" CASCADE;
  ...
  DROP TABLE "homeworks_rels" CASCADE;
  ...
  DROP TABLE "logo_global" CASCADE;
